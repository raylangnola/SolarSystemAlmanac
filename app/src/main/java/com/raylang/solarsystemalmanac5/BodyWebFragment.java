 ...
 * {@link OnWebFragmentListener} interface
 * to handle interaction events.
 */
public class BodyWebFragment extends Fragment {

    private OnWebFragmentListener mListener;

    public BodyWebFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webView = view.findViewById(R.id.body_web_view);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnWebFragmentListener) {
            mListener = (OnWebFragmentListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnWebFragmentListener");
        }
    }
